...
app.use("/api/v1/review",require("./routes/reviewRoutes.js"));
app.use("/api/v1/address",require("./routes/addressRoutes.js"));
app.use("/api/v1/order",require("./routes/orderRoutes.js"));
app.use("/api/v1/question",require("./routes/questionRoutes.js"));
